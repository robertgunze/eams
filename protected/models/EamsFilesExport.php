...
/**
 * This is the model class for table "tbl_eams_files_export".
 *
 ...
 */
class EamsFilesExport extends CActiveRecord
{
	/**
	 ...
	 * @return EamsFilesExport the static model class
	 */
