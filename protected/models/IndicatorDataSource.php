...
/**
 * This is the model class for table "tbl_indicator_data_source".
 *
 * The followings are the available columns in table 'tbl_indicator_data_source':
 * @property integer $id
 ...
 */
class IndicatorDataSource extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_indicator_data_source';
	}
	...
	public function relations()
	{
		...
		return array(
			'eamsFrameworkIndicatorMappings' => array(self::HAS_MANY, 'EamsFrameworkIndicatorMapping', 'data_source_id'),
		);
	}
	 ...
	 * @return IndicatorDataSource the static model class
	 */
